...
var cli struct {
	...
	SourceStyle sourceStyle `group:"terminal" help:"Select the theme for generating distinct source field background colors: ${enum}." enum:"happy,pastel,similar,warm" short:"s" default:"pastel"`
