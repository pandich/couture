...
var cli struct {
	...
	Banner       banner `group:"display" hidden:"true" help:"Show a useful banner." default:"false" negatable:"true" env:"COUTURE_SHOW_BANNER"`
	...
	Width      width      `group:"terminal" help:"Wrap width." placeholder:"width" short:"W"`
	...
	Highlight        highlight        `group:"display" help:"Highlight matches from the patterns specified in --include." negatable:"true" default:"true"`
