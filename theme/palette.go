...
// SplitComplementary ...
func SplitComplementary(mode color.ContrastPolarity, c color.AdaptorColor) Template {
...
// AsTheme ...
func (p Template) AsTheme() Theme {
	th := Theme{}
	p.apply(&th)
	return th
}

func (p Template) apply(th *Theme) {
	p.applySources(th)
	p.applyHeader(th)
	p.applyEntity(th)
	p.applyLevels(th)
...
func (p Template) applySources(th *Theme) {
...
func (p Template) applyHeader(th *Theme) {
...
func (p Template) applyEntity(th *Theme) {
...
func (p Template) applyLevels(th *Theme) {
...
func (p Template) applyMessages(th *Theme) {
